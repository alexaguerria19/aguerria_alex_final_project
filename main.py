...
# creates the speed for which the game updates therfore creating the falling pieces to move at a certain rate
GAME_UPDATE = pygame.USEREVENT
pygame.time.set_timer(GAME_UPDATE, 450)

# creates the game loop where it is constantly being updated
# checks for when a key is pressed to update the score and the positions of the cells
while True:
